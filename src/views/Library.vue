<template lang="html">
  <div class="container m-auto flex flex-col">
    ...
    <div class="p-8">
      <div class="flex flex-row p-8 border-t border-dashed border-grey-lightest" v-for="i in 9" :key="i.id">
        <div class="w-3/4 h-64 flex flex-row border border-grey-lighter">
